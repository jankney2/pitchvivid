select job_users.job_id, admin_notes.notes, users.first_name as firstName, users.last_name as lastName, job_users.video_url, admin_notes.liked, admin_notes.disliked, job_users.user_id as userId, users.email, users.resume
from job_users
